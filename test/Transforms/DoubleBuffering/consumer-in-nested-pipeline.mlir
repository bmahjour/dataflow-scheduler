...
// CHECK-SAME:        %[[SRC:[a-zA-Z0-9_]+]]: memref<64xf16, #ktdp.memory_space<global>>, %[[DST:[a-zA-Z0-9_]+]]: memref<64xf16, #ktdp.memory_space<global>>) {
...
func.func @consumer_nested(%src: memref<64xf16, #ktdp.memory_space<global>>,
